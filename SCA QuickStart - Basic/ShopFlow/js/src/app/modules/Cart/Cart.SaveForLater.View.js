define('Cart.SaveForLater.View', ['ErrorManagement', 'ProductListDetails.View', 'ProductList.Model', 'ProductListItem.Model', 'Cart.Views', 'Session'], function (ErrorManagement, ProductListDetailsView, ProductListModel, ProductListItemModel, CartViews, Session)
{
	...
	var view = CartViews.Detailed.extend({
		...
		render : function()
		{
			console.log('render >> /SCA QuickStart - Basic/ShopFlow/js/src/app/modules/Cart/Cart.SaveForLater.View.js')
			
			CartViews.Detailed.prototype.render.apply(this, arguments);
			
			//this.model.set('swx_filter_save_for_later_client', 'xyla swx_filter_save_for_later_client');
    ...
    ,	renderSaveForLaterSection: function()
		{
			...
			console.log('application.getUser().get(\'isLoggedIn\'): ' + application.getUser().get('isLoggedIn'))
			...
			{
				//var stJsonSaveForLater = JSON.stringify(json, 'key', '\t');
				//console.log('stFilterSaveForLaterClientName: ' + stFilterSaveForLaterClientName + '\n' + 'stJsonSaveForLater: ' + '\n' + stJsonSaveForLater)
	...
	,	validateLogin: function ()
		{
			...
			console.log('validateLogin >> application.getUser().get(\'isLoggedIn\'): ' + application.getUser().get('isLoggedIn'))
