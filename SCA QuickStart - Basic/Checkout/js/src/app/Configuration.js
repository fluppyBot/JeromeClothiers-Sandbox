...
/* The One Page Checkout Scenario */
		...
		,	{
			...
			,	steps: [
					...
					,	hideSummaryItems: true
					,	modules: [
							['OrderWizard.Module.ShowPayments', {edit_url_address: '/opc'}]
						,	['OrderWizard.Module.CartSummary', { container: '#wizard-step-content-right'}]
						,	[	'OrderWizard.Module.Proxy.ShowShipments'
							,	{
									edit_url: '/opc'
					...
					,	save: function()
						{
							...
							else
							{
								...
								{
									custbody_avt_wbs_hold_date_needed_json : 'Config Test'
								});
								**/
				...
				,	{
					...
					,	modules: [
						...
						,	'OrderWizard.Module.RegisterGuest'
						,	'OrderWizard.Module.ShowPayments'
						,	['OrderWizard.Module.Proxy.ShowShipments', { show_combo: true, hide_items: false }]
						]
					,	present: function ()
						{
							this.wizard.application.trackTransaction(this.wizard.model);
			...
			,	steps: [
				...
				,	{
					...
					,	modules: [
						...
						,	['OrderWizard.Module.Proxy.Addresses', {enable_same_as: function () { return !this.wizard.model.get('ismultishipto');}, hide_title: true, title: _('Shipping Address').translate()}]
						]
					}
				]
			}
