...
define('FitProFile.Views', ['Client.Model', 'Profile.Model', 'Profile.Collection','Client.Collection'], function (ClientModel, ProfileModel, ProfileCollection,ClientCollection) {
	'use strict';
