...
Application.defineModel('Profile', {
	...
	get: function ()
	{
		...
		profile.BannerUrl = _.find(customerFieldValues, function(field){
...
Application.defineModel('LiveOrder', {
	...
	get: function ()
	{
		...
		result.isLoggedIn = session.isLoggedIn2();
...
,	addLine: function (line_data)
	{
		...
		,	quantity: parseFloat(line_data.quantity).toFixed(2) == NaN ? 1 : parseFloat(line_data.quantity).toFixed(2)
